...
- Cree un proyecto de React con create-vite: `npm init --yes vite@latest admindashboard.react -- --template=react  --no-rolldown --no-immediate`.
- Actualizando `vite.config.js` con puerto.
- Crear archivo de proyecto (`admindashboard.react.esproj`).
